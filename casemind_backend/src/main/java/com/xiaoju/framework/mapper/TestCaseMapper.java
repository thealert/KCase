...
public interface TestCaseMapper {
    ...
    List<TestCase> searchAll(@Param("caseType") Integer caseType,
                          @Param("caseIds") List<Long> caseIds,
                          @Param("title") String title,
                          @Param("creator") String creator,
                          @Param("requirementId") String requirementId,
    ...
    CaseNumDto searchNum(@Param("caseType") Integer caseType,
                         @Param("caseIds") List<Long> caseIds,
                         @Param("title") String title,
                         @Param("creator") String creator,
                         @Param("requirementId") String requirementId,
    ...
    CaseNumDto searchNumAll(@Param("caseType") Integer caseType,
                         @Param("caseIds") List<Long> caseIds,
                         @Param("title") String title,
                         @Param("creator") String creator,
                         @Param("requirementId") String requirementId,
