...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public JSONObject login(UserLoginReq req, HttpServletRequest request, HttpServletResponse response) {
...
//                .sameSite("None")
//                .build();
//        response.addHeader("Set-Cookie", "username=liutong; Path=/;HttpOnly;SameSite=None; ");
