...
const NoteAddDrawer = (props) => {
  ...
  const submit = () => {
    ...
    // );
    var info={method:selectVal, nodeId: minder.getSelectedNodes()[0].data.id, message: JSON.stringify(newList)};
    window.ws.sendSocketMessage(JSON.stringify({'type':'case_design_event','data':info}))
