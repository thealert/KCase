...
class ReviewModal extends React.Component{
    ...
    componentWillReceiveProps(nextProps) {
        if (
          nextProps.titleModePrview == '编辑评审任务' &&
        ...
        if (
          nextProps.titleModePrview == '新建评审任务' &&
          nextProps.visible != this.props.visible
        ) {
          this.setState({
            radioValue: '0',
      ...
      saveTaskData = values => {
        ...
        if (this.props.titleModePrview == '编辑评审任务') {
        ...
        request(url, { method: 'POST', body: params }).then(res => {
          if (res.code === 200) {
            this.props.handleOkPrview(this.props.record);
      ...
      render() {
        ...
        return (
            <Modal
                ...
                maskClosable={false}
                title={this.props.titleModePrview}
                okText="确认"
                cancelText="取消"
                closable
                ...
                {getFieldDecorator('title', {
                    ...
                    initialValue:
                    this.props.titleModePrview == '编辑评审任务'
