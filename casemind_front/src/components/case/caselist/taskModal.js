...
class TaskModal extends React.Component {
  ...
  saveTaskData = values => {
    ...
    if(! params.review_result )
      params.review_result=0;
      ...
      >
        ...
        <Form.Item {...formItemLayout} label="任务类型：">
          {getFieldDecorator('env', {
            initialValue:
              this.props.titleModeTask == '编辑测试任务'
                ? this.props.record.env
                : 0,
          })(
            <Select  style={{ width: 120 }} onChange={this.handleChangeTaskType}>

              <Option key={3} value={3}>研发自测</Option>
              <Option key={0} value={0}>冒烟测试</Option>
              <Option key={1} value={1}>系统测试</Option>
              <Option key={2} value={2}>回归测试</Option>
