...
class LogIn extends React.PureComponent {
  ...
  componentDidMount(){
    if (getCookies('username')) {
      window.location.href = this.getJumpTarget()
    }
  }

  getDefaultTarget = () => {
    return `${window.location.protocol}//${window.location.host}/mycasemind-cms/`
  }

  getJumpTarget = () => {
    return utils.getQueryString('jumpto') || this.getDefaultTarget()
  }
